...
import PeriodicCustomTitle, { PeriodicCustomTitleSettings } from "src/main";
import { PeriodicReturn, PeriodicType } from "src/utils/get-periodic-config";
import { PeriodicSetting, renderTitle } from "src/utils/title-template";

export const DEFAULT_PERIODIC_SETTING: PeriodicSetting = {
  dateFormat: "",
